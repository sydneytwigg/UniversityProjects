...
<html lang="en">
 ...
 <head>
   <title>Login | Jenni Twigg Designs | Bespoke Jewellery, Clothing & Interiors</title>
   <meta charset="UTF-8">
         ...
         <div class="col-md-6 p-b-30 m-l-r-auto">
           <form class="form-signin" action="userAccount.php" method="post">
            <h4 class="m-text26 p-b-36 p-t-15">
             ...
             <p class="p-b-28">Enter your login details to login to your existing account.</p>
             <!--login-->
             ...
             <div class="w-size25">
               <!-- Button -->
                 <input class="flex-c-m size2 bg1 bo-rad-23 hov1 m-text3 trans-0-4" type="submit" name="loginSubmit" value="Login"></input>
             </div>
             <p class="p-b-28">Don't have an account? <a href="register.php">Sign Up</a></p>
           </form>
