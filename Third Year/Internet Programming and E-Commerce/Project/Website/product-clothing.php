<?php
 ...
 <html lang="en">
 	...
 	<head>
 		<title>Shop - Clothing | Jenni Twigg Designs | Bespoke Jewellery, Clothing & Interiors</title>
 		<meta charset="UTF-8">
 			...
 			<div class="container">
 				<div class="row">
 					<div class="col-sm-6 col-md-8 col-lg-9 p-b-50 m-l-r-auto">
 						...
 						<div class="row">
              <?php
                $sql = "SELECT id, name, price, image FROM products WHERE category='Clothing'";
