...
//Create components
    ...
    //Create buttons
    //JButton btnSearch = new JButton("Search"); //CHANGE #################
    ...
    //btnSearch.addActionListener(this); //CHANGE #################
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        //if statement to determine which button is being pressed
        /*if (source.equals(btnSearch)){                  //search      //CHANGE #################
            this.dispose();
            SearchBooks searchFrame = new SearchBooks();
         ...
         if (source.equals(btnViewBook)){           //view all books
            ...
            JOptionPane.showMessageDialog(null, "Help: Home Page\n\nThis page allows you to navigate through the program. \n\n"
                    ...
                    + "To search for books, click the “Search” button under Books Menu. \n"         //CHANGE #################
